...
class LandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create land" do
    assert_difference('Land.count') do
      post lands_url, params: { land: { agrioffice: @land.agrioffice, area: @land.area, district: @land.district, ownershiptype: @land.ownershiptype, surveyno: @land.surveyno, village: @land.village } }
    end
  ...
  test "should update land" do
    patch land_url(@land), params: { land: { agrioffice: @land.agrioffice, area: @land.area, district: @land.district, ownershiptype: @land.ownershiptype, surveyno: @land.surveyno, village: @land.village } }
