...
class InsurancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post insurances_url, params: { insurance: { amount: @insurance.amount, cropname: @insurance.cropname, rate: @insurance.rate, surveyno: @insurance.surveyno, year: @insurance.year } }
    end
  ...
  test "should update insurance" do
    patch insurance_url(@insurance), params: { insurance: { amount: @insurance.amount, cropname: @insurance.cropname, rate: @insurance.rate, surveyno: @insurance.surveyno, year: @insurance.year } }
