...
class CropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crop" do
    assert_difference('Crop.count') do
      post crops_url, params: { crop: { area: @crop.area, name: @crop.name, surveyno: @crop.surveyno } }
    end
  ...
  test "should update crop" do
    patch crop_url(@crop), params: { crop: { area: @crop.area, name: @crop.name, surveyno: @crop.surveyno } }
